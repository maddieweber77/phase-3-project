...
#         completion_counter_2 = 0
#         #! make the visibility of the restaurant buttons false
...
# ## Section: Initial Setup and UI Display #############################################################
# #! Section: Initial Setup and UI Display #############################################################
# ## Section: Initial Setup and UI Display #############################################################
...
# # - Let's make the restaurant name / party size / bid amount into buttons instead, 
# #   and when you click on the button, it then prompts you to enter a bid for that specific restaurant
...
def show_screen_3(restaurant_name, bid_amount):
    ...
    with ui.row():
        ui.html(f"Bid Successfully Placed for {restaurant_name} for ${bid_amount}")
